...
const padSchema = Joi.object({
  pad_part: Joi.string().allow(null, ""),
  ...
  pad_type: Joi.string()
    ...
    .allow(null, ""),
  spare: Joi.any().valid(null, false, true),
  pediatric_key: Joi.any().valid(null, false, true),
...
const createAedValidation = Joi.object({
  created_by: Joi.number().required(),
  expiration_date: Joi.string().allow(null, ""),
  last_service: Joi.string().allow(null, ""),
  ...
  warranty_date: Joi.string()
    .pattern(/^\d{4}\-\d{2}\-\d{2}$/)
    .allow(null, ""), // YYYY-MM-DD
  installed: Joi.string()
    .pattern(/^\d{4}\-\d{2}\-\d{2}$/)
    .allow(null, ""), // YYYY-MM-DD
  ...
  charge_pak_info: Joi.array()
    ...
    .allow(null, ""),
  spare_charge_pak_info: Joi.array().allow(null, ""),
  ...
  rms_info: Joi.array()
    ...
    .allow(null, ""),
  loaner_serial_id: Joi.number().integer().allow(null, ""),
...
module.exports = { createAedValidation };
